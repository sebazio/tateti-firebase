...
class ActividadPartida : AppCompatActivity() {
    ...
    private fun establecerGanador(ganador: String?) {
        ...
        val referenciaPartidas = database.child(Constantes.TABLA_PARTIDAS) //OK TODO-06-DATABASE cambiar el valor null por el child de la database llamado "Constantes.TABLA_PARTIDAS"
        val referenciaPartida = referenciaPartidas.child(partida?.id!!) //OK TODO-06-DATABASE cambiar el valor null por el child de referenciaPartidas con el id de la partida como parametro
        //OK TODO-06-DATABASE Descomentar la siguiente linea una vez obtenidos los dos datos anteriores
    ...
    private fun crearPartida(posicion: Int) {
        ...
        val database = obtenerReferenciaALaBaseDeDatos()
        val referenciaPartidas = database.child(Constantes.TABLA_PARTIDAS) //OK TODO-06-DATABASE cambiar el valor null por el child de la database llamado "Constantes.TABLA_PARTIDAS"
        val referenciaPartida = referenciaPartidas.push() //OK TODO-06-DATABASE hacer un push() de referenciaPartidas para guardar el valor
        //OK TODO-06-DATABASE Descomentar las dos siguientes linea una vez obtenidos los dos datos anteriores
